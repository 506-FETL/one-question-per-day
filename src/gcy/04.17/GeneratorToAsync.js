...
export default function generatorToAsync(func) {
  if(typeof func !== 'function' || typeof func.prototype?.next !== 'function' || typeof func.prototype?.throw !== 'function')
  {
    throw new TypeError('Input must be a generator function');
  }
  function ispromise(val){
    if(typeof(val) ==='object' &&val !== null&&typeof(val.then)==='function') return true
    else{
      return false
    }
  }
