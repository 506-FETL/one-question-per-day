...
| 类型    | 路径                                      |
| ------- | ----------------------------------------- |
| JS 答案 | problems/days/Day 08/answer.js            |
| TS 答案 | problems/days/Day 08/ts/answer.ts         |
| 模板    | problems/days/Day 08/ts/MyPromise.ts      |
| 模板    | problems/days/Day 08/ts/types.ts          |
| 测试    | problems/days/Day 08/ts/MyPromise.spec.ts |
